...
namespace Jajo.Web.Output.Spark
{
    public class RenderOutputUsingSpark : IRenderOutput
    {
        ...
        public async Task<Stream> Render(IDictionary<string, object> environment)
        {
            ...
            var view = sparkViewEntry.CreateInstance() as JajoSparkView;
        ...
        public static RenderOutputUsingSpark Configure(ITemplateSource templateSource, IDictionary<string, object> environmentSettings)
        {
            ...
            {
                DefaultPageBaseType = typeof(JajoSparkView).FullName,
                ViewFolder = new JajoViewFolder(templates),
                PartialProvider = new JajoPartialProvider()
            };

            environmentSettings["jajo.Spark.ViewEngine"] = sparkViewEngine;
