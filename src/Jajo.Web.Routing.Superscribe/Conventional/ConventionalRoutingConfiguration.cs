...
namespace Jajo.Web.Routing.Superscribe.Conventional
{
    public class ConventionalRoutingConfiguration
    {
        ...
        public IRouteEngine Configure(IEnumerable<Assembly> assemblies, IDictionary<string, object> environmentSettings)
        {
            ...
            environmentSettings["jajo.Superscribe.Engine"] = define;
            ...
            environmentSettings["jajo.RoutedEndpoints.Inputs"] = inputToEndpoint;

            environmentSettings["jajo.RoutedEnpoints.ParametersFromInput"] = (Func<object, IDictionary<string, object>>) (x =>
                {
            ...
            environmentSettings["jajo.ReverseRoute"] = (Func<object, IDictionary<string, object>, string>) ((endpoint, parameters) =>
            {
